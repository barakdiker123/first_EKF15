...
accel_noise_std = np.array([ 0.000001 , 00.000001 , 00.00001 ])
gyro_noise_std = np.array( [ 0.000001, 0.00001 , 0.000001 ]  )
Q = np.eye(12)
...
err_la = 0.00000000
err_h = 0.0000000
err_v = np.array([0.0001,0.001,0.001])
...
simulation_interface.simulation(2,func_acc_gt , func_gyro_gt , Q , x_gt,x_est, P,accel_noise_std ,gyro_noise_std,R_gps)
